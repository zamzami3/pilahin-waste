        ...
        <div className="grid min-h-[520px] md:min-h-[calc(100vh-180px)] md:grid-cols-[1.2fr_1fr]">
          <div className="relative hidden md:block">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?auto=format&fit=crop&w=1400&q=80')",
              }}
            />
            <div className="absolute inset-x-0 bottom-0 bg-forest-emerald/55 p-8 text-white">
              <p className="text-sm uppercase tracking-[0.18em] text-white/85">Pilahin Member Area</p>
              <h2 className="mt-3 text-5xl font-bold leading-[1.03]">Mulai akun baru untuk layanan pilah sampah</h2>
              <p className="mt-4 flex items-center gap-2 text-sm text-white/90">
                Proses registrasi cepat khusus warga
          ...
          <div className="flex items-center bg-slate-50 px-6 py-6 md:px-10">
            <form onSubmit={handleSubmit} className="w-full">
              <div className="mb-6">
                ...
                <h1 className="mt-4 text-4xl font-extrabold leading-tight text-forest-emerald">Create Account</h1>
              ...
              <button type="submit" className="mt-7 w-full rounded-xl bg-black px-6 py-3 text-base font-semibold text-white hover:opacity-95">Create Account</button>

              <div className="mt-6 flex items-center justify-between text-sm text-slate-500">
                <span>pilahin.id</span>
                <span>warga plan</span>
                <span>2026</span>
              </div>
